...
function randomNum() {
    ...
    if (num != 6&&DontHaveOtherFree()) {
        ...
        bad.innerHTML = "Unfortunatlly you stuck,wait the scound turn  &#128532;";
                ...
                if (onboard[currpawn] === 1 || num === 6) {
                    if (onboard[currpawn] === 0) {
                        ...
                        switch (Color) {
                            case "red":
                                /*var r=currPos;
                                var out= parseInt(position) +parseInt(num);
                                console.log("p",position,"kk",num)
                                var t=setInterval(function(){
                                    ...
                                    console.log("dddd",r,"jhjj",out)
                                    stepsRed[r]();
                                    r++;
                                    
                                },100,out,position,num,r);*/
                        ...
                        case "yellow":
                            ...
                            case "blue":
                                ...
                                var t=setInterval(function(){
                                    ...
                                    console.log("dddd",b,"jhjj",out)
                                    stepsBlue[b]();
                                    b++;
                                    
                                },100,out,position,num,b);*/
